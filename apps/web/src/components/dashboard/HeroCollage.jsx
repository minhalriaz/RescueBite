        ...
        <div className="relative z-20 flex h-full items-center px-8 lg:px-14">
          <div className="max-w-xl">
            ...
            <p className="mt-4 max-w-lg text-base leading-7 text-white/75 lg:text-lg">
              Browse available food donations near your organization and request
              pickups for families who need it most.
            </p>
            <div className="mt-6 flex flex-wrap gap-4">
              <Link
                to="/ngo/browse-food"
                className="flex items-center gap-2 rounded-xl bg-[#0F9F76] px-6 py-3 font-semibold text-white shadow-lg shadow-[#0F9F76]/25 transition hover:bg-[#0C8562]"
              >
                Browse Food Donations <ArrowRight size={18} />
              </Link>
              <Link
                to="/ngo/requests"
                className="flex items-center gap-2 rounded-xl border border-white/20 bg-white/5 px-6 py-3 text-white backdrop-blur-sm transition hover:bg-white/10"
              >
                View My Requests
              </Link>
            </div>
      ...
      <section className="relative h-[360px] overflow-hidden rounded-3xl shadow-2xl shadow-black/40 lg:h-[390px]">
        ...
        <div className="relative z-20 flex h-full items-center px-8 lg:px-14">
          <div className="max-w-xl">
            ...
            <h1 className="text-4xl font-extrabold leading-tight lg:text-5xl">
              <span className="text-white">Support Food</span>
              <br />
              <span className="text-[#34D399]">Rescue.</span>
            </h1>
            <p className="mt-4 max-w-lg text-base leading-7 text-white/75 lg:text-lg">
              Volunteers help collect and deliver rescued food to community
              partners, shelters, and families while keeping surplus meals
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              <a
                ...
                className="flex items-center gap-2 rounded-xl bg-[#0F9F76] px-6 py-3 font-semibold text-white shadow-lg shadow-[#0F9F76]/25 transition hover:bg-[#0C8562]"
              >
                View Pickup Tasks <ArrowRight size={18} />
              </a>
              <a
                href="#pickup-tasks"
                className="flex items-center gap-2 rounded-xl border border-white/20 bg-white/5 px-6 py-3 text-white backdrop-blur-sm transition hover:bg-white/10"
      ...
      <div className="relative z-20 flex items-center h-full px-8 lg:px-14">
        <div className="max-w-xl">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold leading-tight">
            <span className="text-white">Every Donation</span>

            <br />

            <span className="text-[#34D399]">Creates Hope.</span>
          </h1>

          {/* Description */}
          <p className="mt-4 max-w-lg text-base lg:text-lg leading-7 text-white/75">
            Help NGOs and volunteers rescue surplus food and deliver it to
